...
$query=mysqli_query($con, "insert into tblusers(FirstName,LastName, School, Email, Department,ProfilePic) value('$fname','$lname', '$schl', '$email', '$add','$imgnewfile' )");
if ($query) {
...
<div class="signup-form">
    <form  method="POST" enctype="multipart/form-data" >
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="school" placeholder="Enter your School" required="true">
        </div>
        <div class="form-group">
		...
		<div class="form-group">
            <input class="form-control" name="department" placeholder="Enter Your Department" required="true">
        </div>  
             <div class="form-group">
