...
if(isset($_POST['submit']))
  {
    ...
    //Query for data updation
     $query=mysqli_query($con, "update  tblusers set FirstName='$fname',LastName='$lname', School='$schl', Email='$email', Department='$add' where ID='$eid'");
...
<a href="change-image.php?userid=<?php echo $row['ID'];?>">Change Image</a>
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="school" value="<?php  echo $row['School'];?>" required="true">
        </div>
        <div class="form-group">
		...
		<div class="form-group">
            <input class="form-control" name="department" required="true" value="<?php  echo $row['Department'];?>">
        </div>   
